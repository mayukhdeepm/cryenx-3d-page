const ButtonSvg = (purple: boolean) => (
  <>
    <svg
    ...
    >
      <path
        fill={purple ? "#155EFC" : "none"}
        stroke={purple ? "#155EFC" : "url(#btn-left)"} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
    ...
    >
      {purple ? (
        ...
        <>
          <polygon
            fill="#155EFC" // mentioned in ButtonGradient.jsx
            fillRule="nonzero"
    ...
    >
      <path
        fill={purple ? "#155EFC" : "none"}
        stroke={purple ? "#155EFC" : "url(#btn-right)"} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
